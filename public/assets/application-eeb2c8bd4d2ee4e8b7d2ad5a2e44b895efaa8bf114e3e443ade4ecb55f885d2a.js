...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'max': { range: '*', href: '/assets/style/style.scss', containers: 1440, viewport: { scalable: false }, grid: { gutters: 40 } },
			'wide': { range: '-1920', href: '/assets/style/style-wide.scss', containers: 1360 },
			'normal': { range: '-1680', href: '/assets/style/style-normal.css', containers: 1200 },
			'narrow': { range: '-1280', href: '/assets/style/style-narrow.css', containers: 960 },
			'narrower': { range: '-1000', href: '/assets/style/style-narrower.css', containers: '95%' },
			'mobile': { range: '-736', href: '/assets/style/style-mobile.css', grid: { gutters: 20 } },
